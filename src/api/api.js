...
const api_post_call = (endpoint) => async (body) => {
...
const get_user_data = async (user_id) => {
    return fetch(BUDDIES_API + "user/" + user_id).then(response => {
...
const create_buddy = (user_id, name, notes, birthday, cadence, location) => {
    return api_post_call("buddy/create")({
	user_id: user_id,
	name: name,
	notes: notes,
	birthday: birthday,
...
const create_interaction = (user_id, notes, participants, date) => {
    return api_post_call("interaction/create")({
	user_id: user_id,
	notes: notes,
...
const archive_buddy = (user_id, buddy_id) => api_post_call("buddy/archive")({
    user_id: user_id,
    buddy_id: buddy_id,
});

const archive_interaction = (user_id, interaction_id) => api_post_call("interaction/archive")({
    user_id: user_id,
...
const buddies_service = {
    ...
    update_buddy: api_post_call("buddy/update"),
    update_interaction: api_post_call("interaction/update"),
    get_user_data: get_user_data
};

// Debug function to call the API and generate some fake data
const setup_fake_data =  async (user_id) => {
    const fake_buddies = [
	...
	let resp = await buddies_service.create_buddy(user_id, name, notes, birthday);
	...
	await buddies_service.create_interaction(user_id, notes, participants, date);
    }
}
